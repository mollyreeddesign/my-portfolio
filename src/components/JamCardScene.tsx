    ...
    <div className="absolute inset-0">
      <div className="relative w-full h-full">
        ...
        <img
          ...
          alt=""
          className={`absolute left-1/2 -translate-x-1/2 -bottom-12 z-[10] h-[100%] w-auto object-contain drop-shadow-md transition-transform duration-300 ease-out transform-gpu ${hovered ? "-translate-y-[30px] scale-110" : "translate-y-0"}`}
          loading="lazy"
        />
