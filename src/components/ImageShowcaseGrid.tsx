...
export default function ImageShowcaseGrid({ images, className, rightTallBgClass = "bg-white" }: ImageShowcaseGridProps) {
  ...
  return (
    <div className={("grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_0.7fr] gap-4 mt-4 bg-gray-100 " + (className || "")).trim()}>
      {/* Row 1 */}
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-1 lg:row-start-1 lg:row-span-2 lg:aspect-[5/2.3]">
      ...
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-2 lg:row-start-1 lg:aspect-[4/1]">
      ...
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-3 lg:row-start-1 lg:row-span-4 lg:aspect-[4/4]">
      ...
      {/* Row 2 */}
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-1 lg:row-start-3 lg:row-span-2 lg:aspect-[5/2]">
      ...
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-2 lg:row-start-2 lg:row-span-3 lg:aspect-[5/3]">
      ...
      <div className={("group relative w-full rounded-lg overflow-hidden border border-gray-200 shadow-lg lg:col-start-3 lg:row-start-4 lg:row-span-3 lg:aspect-[1/1.4] " + rightTallBgClass).trim()}>
      ...
      <div className="group relative w-full rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg lg:col-start-1 lg:col-span-2 lg:row-start-5 lg:row-span-2 lg:aspect-[11/4]">
