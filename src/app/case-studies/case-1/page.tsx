                ...
                <Tabs
                  items={[
                    ...
                    },
                    {
                      ...
                      content: (
                        <div>
                          <h3 className="custom-h3 mb-2">Typography</h3>
                          <p className="p mb-4">Consistent font and hierarchy brought over from the brand system.</p>
                          <p className="text-[28px] leading-[36px] font-americana">Americana Headline</p>
                          <p className="p">Body text example using the site’s paragraph style.</p>
                        </div>
                      ),
                    },
                    {
                      ...
                      content: (
                        <div>
                          <h3 className="custom-h3 mb-2">Buttons</h3>
                          <p className="p mb-4">Primary and secondary buttons that align with the Hilton UI kit.</p>
